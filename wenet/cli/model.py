...
class Model:
    ...
    def __init__(self,
        ...
        if context_path is not None:
            # context_score is the threshold of context score
...
def load_model(language: str = None,
    ...
    model = Model(model_dir, beam, context_path=context_path, context_score=context_score)
    log.info(f"loaded model --{language} from {model_dir}")
